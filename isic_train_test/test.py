...
if __name__ == '__main__':
    ...
    parser.add_argument('--dataset', default='/tmp/pycharm_project_794/BRAU-Netplusplus-master/isic_cvc_train_test/data',type=str, help='the path of dataset')
    # parser.add_argument('--csvfile', default='src/test_train_data.csv',type=str, help='two columns [image_id,category(train/test)]')
    parser.add_argument('--csvfile', default='/tmp/pycharm_project_794/BRAU-Netplusplus-master/isic_cvc_train_test/test_train_data.csv',type=str, help='two columns [image_id,category(train/test)]')
    parser.add_argument('--model',default='save_models/epoch_last_20250113_0949.pth', type=str, help='the path of model')
    ...
    for image_id in test_files:
        ...
        img = cv2.imread(f'/tmp/pycharm_project_794/BRAU-Netplusplus-master/isic_cvc_train_test/data/images/{image_id}')
    ...
    with torch.no_grad():  # 禁用梯度计算
        for img, mask, img_id in test_dataset:
            ...
            # 加载原始图像
            orig_img_path = f'/tmp/pycharm_project_794/BRAU-Netplusplus-master/isic_cvc_train_test/data/images/{img_id}.png'
