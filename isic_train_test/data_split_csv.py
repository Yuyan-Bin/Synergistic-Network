...
def pre_csv(data_path,frac):
    ...
    df.to_csv('/tmp/pycharm_project_794/BRAU-Netplusplus-master/isic_cvc_train_test/test_train_data.csv',index=False)
...
if __name__ == '__main__':
    ...
    parser.add_argument('--dataset', type=str, default=r'/tmp/pycharm_project_794/BRAU-Netplusplus-master/isic_cvc_train_test/data/images/', help='the path of images') # issue 16
    parser.add_argument('--size', type=float, default=0.9, help='the size of your train set')
    args = parser.parse_args()
    # os.makedirs('src/',exist_ok=True)
    os.makedirs('/tmp/pycharm_project_794/BRAU-Netplusplus-master/isic_cvc_train_test/',exist_ok=True)
